...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 " >
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/LogoOficial.png" alt=" Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="propietarios" class="nav-link ">
                  ...
                  <p>Ópcion <i class="fas fa-users"></i></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="propietarios" class="nav-link ">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <!-- insertara contenido de manera dimanica dependiendo de la pagina donde se tabaja -->
